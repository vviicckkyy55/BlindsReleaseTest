...
import {video} from "../models/playlist.js";
...
screenRouter.post(
  ...
  isMasterOrAdmin,
  expressAsyncHandler(async (req, res) => {
    var screenid = mongoose.Types.ObjectId();
    ...
    const Video = new video({
      uploaderId: req.user._id,
        uploader_name: "Vicky",
        upload_title: "onepiece",
        video_path: "http://localhost:3333/api/videos/onepiece.mp4",
        thumbnail_path: "http://localhost:3333/api/videos/video_thumbnails/onepiece.jpg"
      }, {
        timestamps: true,
    })
